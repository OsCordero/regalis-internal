...
//             <Link  passHref to="/" className="block" aria-label="Cruip">
...
//               <li>
//                 <Link  passHref to="/signin" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Sign in</Link>
//               </li>
//               <li>
//                 <Link  passHref to="/signup" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3">
//                   <span>Sign up</span>
