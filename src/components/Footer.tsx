  ...
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-12 gap-2 py-4 md:py-6 border-t border-gray-200">
          {/* 1st block */}
            ...
            <div className="mb-2">
              ...
              <Link href="/" aria-label="Cruip">
                <a className="inline-block">
                  <img src="/logo.png" alt="Regalis" width="55" height="55" />
                </a>
              </Link>
            </div>
          </div>
        ...
        {/*
            <li className="ml-4">
              <Link href="#" passHref aria-label="Github">
                <a className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out">
                  <svg
                    className="w-8 h-8 fill-current"
                    viewBox="0 0 32 32"
        ...
        {/* <div className="text-sm text-gray-600 mr-4">
            ...
            <a
              ...
              href="https://zingiber.vercel.app/"
            >
              {" "}
              Zingiber Labs
            </a>
